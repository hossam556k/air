  ...
  return (
    ...
    <div className="flex items-center justify-center mt-20 bg-gray-900">
      <div className=" flex flex-col lg:flex lg:flex-row sm:items-center justify-center items-center  ">
        ...
        <div className="flex flex-col gap-6 shadow-2xl p-10 bg-white-50  text-center z-100">
          <h3 className="text-4xl font-bold  text-blue-300 ">
          Benefits Of Vents Cleaning{" "}
          </h3>
          ...
          <div className="flex  items-start justify-start">
            ...
            <button className="text-white text-2xl px-6 py-4 rounded-lg bg-transparent border-2 border-blue-300 mt-4 hover:bg-blue-300">contact us</button>
          </div>
        </div>
        <div>
